...
<script src="{$base_url}modules/mpstockservice/views/js/swal2/request/SwalConfirm.js"></script>
<script src="{$base_url}modules/mpstockservice/views/js/swal2/request/SwalError.js"></script>
<script src="{$base_url}modules/mpstockservice/views/js/swal2/request/SwalInput.js"></script>
<script src="{$base_url}modules/mpstockservice/views/js/swal2/request/SwalLoading.js"></script>
<script src="{$base_url}modules/mpstockservice/views/js/swal2/request/SwalNote.js"></script>
<script src="{$base_url}modules/mpstockservice/views/js/swal2/request/SwalSuccess.js"></script>
<script src="{$base_url}modules/mpstockservice/views/js/swal2/request/SwalWarning.js"></script>

<script type="module">
    // Importiamo la classe FileUpload e la rendiamo disponibile globalmente
    import FileUpload from '/modules/mpstockservice/views/js/Tools/FileUpload.js';
    window.FileUpload = FileUpload;

    // Importiamo le funzioni dai moduli
    import * as DisplayProductExtra from '/modules/mpstockservice/views/js/Hooks/DisplayProductExtra.js';
    import { initStockService } from '/modules/mpstockservice/views/js/Hooks/ProductExtraInit.js';
